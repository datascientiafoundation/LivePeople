...
resources:
  - name: Dataset paper and data collection methodology
    ...
    format: PDF
  - name: Codebook
    url: https://datascientiafoundation.github.io/LivePeople-Documentation/codebooks/2020_DV1_San-Luis-Potosi_survey3.html
    format: html
...
download request:
  ...
  - name: Guidelines
    ...
    format: 
title: 2020-DiversityOne-San Luis Potosí-Questionnaire Part 3
...
ds:DatExpires: 
ds:DatSensorName: Questionnaire Part 3
...
ds:DatIdentifier: 004.AAAD.AAH.AA.3
ds:DatChangelogURL: 
license: >-
