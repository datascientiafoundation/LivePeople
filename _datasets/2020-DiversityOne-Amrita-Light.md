...
resources:
  - name: Dataset paper and data collection methodology
    ...
    format: PDF
  - name: Codebook
    url: https://datascientiafoundation.github.io/LivePeople-Documentation/codebooks/2020_DV1_Amrita_light.html
    format: html
  - name: 
    url: 
    format: 
...
ds:DatIdentifier: 004.AAAD.AAG.AR
ds:DatChangelogURL: 
license: >-
