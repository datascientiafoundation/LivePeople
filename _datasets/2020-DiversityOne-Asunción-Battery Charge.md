...
resources:
  ...
  - name: Dataset paper and data collection methodology
    ...
    format: PDF
  - name: Codebook
    url: https://datascientiafoundation.github.io/LivePeople-Documentation/codebooks/2020_DV1_Asuncion_batterycharge.html
    format: html
download request:
  - name: Download request
    url: https://datascientiafoundation.github.io/LivePeople/resources/download_request.pdf
    format: PDF
title: 2020-DiversityOne-Asunción-Battery Charge
...
ds:DatIdentifier: 004.AAAD.AAD.BT
ds:DatChangelogURL: 
license: >-
