...
resources:
  ...
  - name: 
    ...
    format: 
  - name: Codebook
    url: https://datascientiafoundation.github.io/LivePeople-Documentation/codebooks/2020_DV1_Copenhagen_pressure.html
    format: html
download request:
...
ds:DatIdentifier: 004.AAAD.AAC.AS
ds:DatChangelogURL: 
license: >-
