...
resources:
  - name: Dataset paper and data collection methodology
    ...
    format: PDF
  - name: Codebook
    url: https://datascientiafoundation.github.io/LivePeople-Documentation/codebooks/2020_DV1_Jilin_airplanemode.html
    format: html
  - name: 
    url: 
    format: 
...
ds:DatExpires: 
ds:DatSensorName: Airplane Mode
ds:DatType: Sensor
ds:DatSensorType: 
  - Device-usage
...
ds:DatIdentifier: 004.AAAD.AAF.BS
ds:DatChangelogURL: 
license: >-
