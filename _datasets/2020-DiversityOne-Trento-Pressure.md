...
resources:
  ...
  - name: 
    ...
    format: 
  - name: Codebook
    url: https://datascientiafoundation.github.io/LivePeople-Documentation/codebooks/2020_DV1_Trento_pressure.html
    format: html
download request:
...
ds:DatIdentifier: 004.AAAD.AAA.AS
ds:DatChangelogURL: 
license: >-
