...
resources:
  - name: Dataset paper and data collection methodology
    ...
    format: PDF
  - name: Codebook
    url: https://datascientiafoundation.github.io/LivePeople-Documentation/codebooks/2020_DV1_Asuncion_questionnaire_c.html
    format: html
...
download request:
  - name: Download request
    ...
    format: PDF
title: 2020-DiversityOne-Asunción-Questionnaire Part 3
...
ds:DatIdentifier: 004.AAAD.AAD.AA.3
ds:DatChangelogURL: 
license: >-
