...
resources:
  - name: Dataset paper and data collection methodology
    ...
    format: PDF
  - name: Codebook
    url: https://datascientiafoundation.github.io/LivePeople-Documentation/codebooks/2020_DV1_Jilin_location_rd.html
    format: html
  - name: 
    url: 
    format: 
...
ds:DatIdentifier: 004.AAAD.AAF.CD
ds:DatChangelogURL: 
license: >-
