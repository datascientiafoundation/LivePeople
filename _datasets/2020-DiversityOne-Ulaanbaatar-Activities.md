...
resources:
  - name: Dataset paper and data collection methodology
    ...
    format: PDF
  - name: Codebook
    url: https://datascientiafoundation.github.io/LivePeople-Documentation/codebooks/2020_DV1_Ulan-Bator_activities.html
    format: html
  - name: 
    url: 
    format: 
download request:
  - name: Coming soon
title: 2020-DiversityOne-Ulaanbaatar-Activities
...
ds:DatIdentifier: 004.AAAD.AAB.CF
ds:DatChangelogURL: 
license: >-
