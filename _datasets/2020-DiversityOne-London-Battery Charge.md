...
resources:
  - name: Dataset paper and data collection methodology
    ...
    format: PDF
  - name: Codebook
    url: https://datascientiafoundation.github.io/LivePeople-Documentation/codebooks/2020_DV1_London_batterycharge.html
    format: html
  - name: 
    url: 
    format: 
download request:
  - name: 
    url: 
    url: 
title: 2020-DiversityOne-London-Battery Charge
...
ds:DatIdentifier: 004.AAAD.AAE.BT
ds:DatChangelogURL: 
license: >-
