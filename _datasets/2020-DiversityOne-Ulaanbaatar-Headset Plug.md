...
resources:
  - name: Dataset paper and data collection methodology
    ...
    format: PDF
  - name: Codebook
    url: https://datascientiafoundation.github.io/LivePeople-Documentation/codebooks/2020_DV1_Ulan-Bator_headsetplug.html
    format: html
  - name: 
    url: 
    format: 
download request:
  - name: Coming soon
    url: 
title: 2020-DiversityOne-Ulaanbaatar-Headset Plug
...
ds:DatIdentifier: 004.AAAD.AAB.AH
ds:DatChangelogURL: 
license: >-
