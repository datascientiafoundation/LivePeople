...
resources:
  - name: Dataset paper and data collection methodology
    ...
    format: PDF
  - name: Codebook
    url: https://datascientiafoundation.github.io/LivePeople-Documentation/codebooks/2020_DV1_Asuncion_survey1.html
    format: html
...
download request:
  ...
  - name: Guidelines
    ...
    format: 
title: 2020-DiversityOne-Asunción-Questionnaire Part 1
...
ds:DatIdentifier: 004.AAAD.AAD.AA.1
ds:DatChangelogURL: 
license: >-
