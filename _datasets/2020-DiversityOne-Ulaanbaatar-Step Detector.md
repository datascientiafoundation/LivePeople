...
resources:
  - name: Dataset paper and data collection methodology
    ...
    format: PDF
  - name: Codebook
    url: https://datascientiafoundation.github.io/LivePeople-Documentation/codebooks/2020_DV1_Ulan-Bator_stepdetector.html
    format: html
  - name: 
    url: 
    format: 
download request:
  ...
  - name: Guidelines
    ...
    format: 
title: 2020-DiversityOne-Ulaanbaatar-Step Detector
...
ds:DatIdentifier: 004.AAAD.AAB.BI
ds:DatChangelogURL: 
license: >-
