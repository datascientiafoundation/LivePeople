...
resources:
  ...
  - name: 
    ...
    format: 
  - name: Codebook
    url: https://datascientiafoundation.github.io/LivePeople-Documentation/codebooks/2024-MAK-Kampala-accelerometer.html
    format: html
  - name: 
    url: 
    format: 
...
ds:DatIdentifier: 007.AAAN.AAN.AY
ds:DatChangelogURL: 
license: >-
