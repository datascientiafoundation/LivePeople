...
resources:
  ...
  - name: 
    ...
    format: 
  - name: Codebook
    url: https://datascientiafoundation.github.io/LivePeople-Documentation/codebooks/2024-MAK-Kampala-accelerometeruncalibrated.html
    format: html
  - name: 
    url: 
    format: 
...
ds:DatExpires: 
ds:DatSensorName: Accelerometer Uncalibrated
ds:DatType: Sensor
ds:DatSensorType: 
  - Motion
...
ds:DatIdentifier: 007.AAAN.AAN.AZ
ds:DatChangelogURL: 
license: >-
