...
resources:
  - name: Dataset paper and data collection methodology
    ...
    format: PDF
  - name: Codebook
    url: https://datascientiafoundation.github.io/LivePeople-Documentation/codebooks/2020_DV1_London_gyroscope.html
    format: html
  - name: 
    url: 
    format: 
...
ds:DatIdentifier: 004.AAAD.AAE.BB
ds:DatChangelogURL: 
license: >-
