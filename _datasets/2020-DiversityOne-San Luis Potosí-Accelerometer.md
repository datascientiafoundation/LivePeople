...
resources:
  ...
  - name: Dataset paper and data collection methodology
    ...
    format: PDF
  - name: Codebook
    url: https://datascientiafoundation.github.io/LivePeople-Documentation/codebooks/2020_DV1_San-Luis-Potosi_accelerometer.html
    format: html
download request:
...
ds:DatIdentifier: 004.AAAD.AAH.AY
ds:DatChangelogURL: 
license: >-
